  ...
  <div class="page-container">
    <div class="page-header">
      <h2 class="page-title">
        ...
        {{ t('menu.security.databaseAccess') }}
      </h2>
      <p class="page-description">{{ t('securityPolicy.databaseAccess.description') }}</p>
    </div>
...
import { Coin, Plus, Edit, Delete, Download, Upload, VideoPlay, VideoPause } from '@element-plus/icons-vue'
...
const fetchData = async () => {
  ...
  try {
    ...
    tableData.value = [
      { id: '1', name: 'DB-Rule-1', protocol: 'TCP', source: 'group1', destination: 'group2', destinationPort: 3306, inDevicePort: 33060, enable: true, inInterface: 'eth0', inDevice: '192.168.1.1', timeGroup: '' },
      { id: '2', name: 'DB-Rule-2', protocol: 'UDP', source: 'group2', destination: 'group1', destinationPort: 1433, inDevicePort: 14330, enable: false, inInterface: 'eth1', inDevice: '10.0.0.1', timeGroup: 'workday' }
    ]
    total.value = 2
  } finally {
    loading.value = false
...
const handleSubmit = async () => {
  try {
    ...
    await new Promise(resolve => setTimeout(resolve, 500))
    ElMessage.success(dialogMode.value === 'add' ? t('common.success') : t('common.success'))
